...
const CategoryForm: React.FC = () => {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      const fetchResponse = await fetch("https://localhost:7240/api/Categories", {
        method: "POST",
        headers: {
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div className="space-y-2">
          ...
          <Input
            ...
            id="name"
            {...register("name")}
            className={`mt-1 p-2 w-full rounded-md border ${errors.name ? "border-red-500" : "border-gray-300 dark:border-gray-600"
        ...
        <div className="space-y-2">
          ...
          <textarea
            ...
            className={`mt-1 p-2 w-full bg-white dark:bg-slate-950 rounded-md  border ${errors.description ? "border-red-500" : "border-gray-300 dark:border-gray-600"
              } focus:ring-blue-500 focus:border-blue-500`}
          ></textarea>
          {errors.description && (
